...
/**
 * This is an attempt to come up with my own hash data structure.
 * 
 * @author saurabh
 *
 */
public class TMHashMap {
	...
	public static void main(String[] args) {
		...
		Employee e1 = new Employee(100, "Saurabh");
		tmhm.put(e1, "dept1");

		// duplicate
		System.out.println("Adding Duplicate =======");
		Employee e1_dup = new Employee(100, "Saurabh");
		...
		Employee e2 = new Employee(102, "Rishi");
		tmhm.put(e2, "dept3");

		Employee e3 = new Employee(104, "Nitin");
		tmhm.put(e3, "dept2");

		Employee e4 = new Employee(106, "Dhawal");
		tmhm.put(e4, "dept5");

		Employee e5 = new Employee(108, "Iqbal");
		tmhm.put(e5, "dept2");

		// collision with e2
		System.out.println("Adding Collisions ===========");
		Employee e2_collision = new Employee(112, "Zakeer");
		tmhm.put(e2_collision, "dept16");
		e = tmhm.get(e2_collision);
		System.out.println("GET element - " + e.getKey() + "::" + e.getValue());

		// collision with e3
		Employee e3_collision = new Employee(114, "Raja");
